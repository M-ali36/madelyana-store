      ...
      <div className="max-w-7xl mx-auto container px-4">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-y-0 -start-6 flex items-center z-20">
            <div className="tiktok-prev h-12 w-12 rounded-full bg-white flex items-center justify-center hover:bg-neutral-300 transition cursor-pointer text-neutral-900 shadow">
              <HiArrowRight className="w-6 h-6 rotate-180 rtl:rotate-0" />
            </div>
          </div>

          <div className="absolute inset-y-0 -end-6 flex items-center z-20">
            <div className="tiktok-next h-12 w-12 rounded-full bg-white flex items-center justify-center hover:bg-neutral-300 transition cursor-pointer text-neutral-900 shadow">
              <HiArrowRight className="w-6 h-6 rtl:rotate-180" />
            </div>
          </div>
            ...
            {videos.map((item, index) => (
              <SwiperSlide key={index}>
                <a
                  ...
                  className="block group relative rounded-lg overflow-hidden w-full text-start"
                >
